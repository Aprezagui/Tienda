                ...
                <div class="dropdown-content">
                    <?php
                        if(!isset($_SESSION["rol"])){
                            echo '<a href="' . site_url('home/vista/registro') . '">¿Primera visita? Registrate</a>';
                            echo "<hr/>";
                        } 
                    ?>
                    <a href="<?php echo site_url('home/vista/perfil');?>">Mi perfil</a>
